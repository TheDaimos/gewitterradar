...
assert.match(sourceText,/const CARD_VERSION = '4\.09\.06';/,'V4.09.06 card version missing');
assert.match(sourceText,/const CARD_DISPLAY_VERSION = '4\.09\.06';/,'V4.09.06 display version missing');
assert.match(sourceText,/V4\.09\.06-DEV-2026-09-20/,'V4.09.06 build marker missing');
...
for(const needle of [
  ...
  'width:clamp(188.5px,31.2vmin,390px)',
  'width:clamp(171.6px,46.8vmin,299px)',
  ...
  "MAP_LOCATION_POSITION_STORAGE_KEY = 'gewitterradar:v409:map-location-position'",
  '_positionMapLocationOverlay',
  '_persistMapLocationPosition',
  '_scheduleMapLocationDropdownLayout',
  'bindMapLocationDrag',
  'map-adaptive-columns',
  'dataset.layoutColumns',
  'dataset.layoutDirection',
  ...
  "targetUrl.searchParams.set(MAP_WINDOW_VERSION_QUERY_KEY,'40906')",
...
assert.ok(sourceText.includes('V4.09.06 · DEV · 2026/09'),'V4.09.06 DEV release-history entry missing');
...
console.log('PASS: V4.09.06 movable fullscreen location pill, live adaptive location menu, V4.09.05 touch protections, delivery parity and protected V4.08 assets/locales.');
