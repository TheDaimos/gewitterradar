...
assert.match(sourceText,/const CARD_VERSION = '4\.09\.07';/,'V4.09.07 card version missing');
assert.match(sourceText,/const CARD_DISPLAY_VERSION = '4\.09\.07';/,'V4.09.07 display version missing');
assert.match(sourceText,/V4\.09\.07-DEV-2026-09-20/,'V4.09.07 build marker missing');
...
for(const needle of [
  ...
  "targetUrl.searchParams.set(MAP_WINDOW_VERSION_QUERY_KEY,'40907')",
...
assert.ok(sourceText.includes('V4.09.07 · DEV · 2026/09'),'V4.09.07 DEV release-history entry missing');
...
console.log('PASS: V4.09.07 movable fullscreen location pill, adaptive live dropdown, V4.09.05 touch contract, delivery parity and protected V4.08 assets/locales.');
