...
export async function build(){
 ...
 console.log('Built Gewitterradar V4.09 final from the accepted V4.09.28 candidate with release-metadata normalization plus diagnostic selector scope correction.');
