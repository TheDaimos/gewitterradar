...
const pkgV407Text=(await readFile(resolve(root,'home-assistant/app_gewitterradar_v4_07_pkg.yaml'),'utf8')).replace(/\r\n?/g,'\n');
const pkgV407=Buffer.from(pkgV407Text,'utf8');
if(!(await readFile(resolve(root,'dashboard/dist/app_gewitterradar_v4_07_pkg.yaml'))).equals(pkgV407))throw Error('V4.07 staged dashboard package parity failed');
