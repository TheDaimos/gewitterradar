...
export function v407Test32ReviewPolishDelta(source) {
  ...
  const cssAnchor='.help-action-use:before{content:"";position:absolute;inset:2px;border:1px solid rgba(174,218,243,.11);border-radius:.18em;box-shadow:inset 0 1px 0 rgba(226,246,255,.07),inset 0 -1px 0 rgba(7,18,25,.32);pointer-events:none}';
