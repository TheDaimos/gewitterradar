...
const SETTINGS_UI_TRANSLATIONS=Object.freeze({
  "Deutsch": {
    ...
    "app.release_history": "Versionsverlauf",
    "app.release_history_open": "Versionsverlauf öffnen",
    "settings.cluster_resolution_select": "Cluster-Auflösung auswählen",
    "settings.cluster_navigation_session_aria": "Sitzungszeit der Cluster-Navigation",
    "settings.cluster_navigation_seconds_aria": "Sitzungszeit der Cluster-Navigation in Sekunden",
    "settings.cluster_navigation_infinite_aria": "Cluster-Navigation unbegrenzt beibehalten",
    "settings.cluster_navigation_to_session": "Zur Sitzungszeit wechseln",
    "settings.cluster_navigation_to_infinite": "Auf unbegrenzt wechseln",
    "settings.map_startup_select": "Standardansicht auswählen",
    "map.medallion_move": "Medaillon auf der Karte verschieben",
    "compass.picker_title": "Kompassauswahl",
    "compass.picker_change": "Kompass wechseln",
    ...
    "modules.status.duplicate": "doppelte Registrierung",
    "modules.deviation.registrations": "Registrierungen",
    "modules.deviation.active_matches": "Aktive Modulversion entspricht dem Sollstand",
  ...
  "English": {
    ...
    "app.release_history": "Release history",
    "app.release_history_open": "Open release history",
    "settings.cluster_resolution_select": "Select cluster resolution",
    "settings.cluster_navigation_session_aria": "Cluster navigation session time",
    "settings.cluster_navigation_seconds_aria": "Cluster navigation session time in seconds",
    "settings.cluster_navigation_infinite_aria": "Keep cluster navigation unlimited",
    "settings.cluster_navigation_to_session": "Switch to session time",
    "settings.cluster_navigation_to_infinite": "Switch to unlimited",
    "settings.map_startup_select": "Select default view",
    "map.medallion_move": "Move medallion on the map",
    "compass.picker_title": "Compass selection",
    "compass.picker_change": "Change compass",
    ...
    "modules.status.duplicate": "duplicate registration",
    "modules.deviation.registrations": "Registrations",
    "modules.deviation.active_matches": "Active module version matches the target state",
  ...
  "Dansk": {
    ...
    "app.release_history": "Versionshistorik",
    "app.release_history_open": "Åbn versionshistorik",
    "settings.cluster_resolution_select": "Vælg klyngeopløsning",
    "settings.cluster_navigation_session_aria": "Sessionstid for klyngenavigation",
    "settings.cluster_navigation_seconds_aria": "Sessionstid for klyngenavigation i sekunder",
    "settings.cluster_navigation_infinite_aria": "Bevar klyngenavigation ubegrænset",
    "settings.cluster_navigation_to_session": "Skift til sessionstid",
    "settings.cluster_navigation_to_infinite": "Skift til ubegrænset",
    "settings.map_startup_select": "Vælg standardvisning",
    "map.medallion_move": "Flyt medaljonen på kortet",
    "compass.picker_title": "Kompasvalg",
    "compass.picker_change": "Skift kompas",
    ...
    "modules.status.duplicate": "dobbelt registrering",
    "modules.deviation.registrations": "Registreringer",
    "modules.deviation.active_matches": "Den aktive modulversion matcher måltilstanden",
    "modules.status.ok": "korrekt",
  ...
  "Español": {
    ...
    "app.release_history": "Historial de versiones",
    "app.release_history_open": "Abrir historial de versiones",
    "settings.cluster_resolution_select": "Seleccionar resolución de clústeres",
    "settings.cluster_navigation_session_aria": "Duración de sesión de la navegación de clústeres",
    "settings.cluster_navigation_seconds_aria": "Duración de sesión de la navegación de clústeres en segundos",
    "settings.cluster_navigation_infinite_aria": "Mantener ilimitada la navegación de clústeres",
    "settings.cluster_navigation_to_session": "Cambiar a duración de sesión",
    "settings.cluster_navigation_to_infinite": "Cambiar a ilimitado",
    "settings.map_startup_select": "Seleccionar vista predeterminada",
    "map.medallion_move": "Mover el medallón en el mapa",
    "compass.picker_title": "Selección de brújula",
    "compass.picker_change": "Cambiar brújula",
    ...
    "modules.status.duplicate": "registro duplicado",
    "modules.deviation.registrations": "Registros",
    "modules.deviation.active_matches": "La versión activa del módulo coincide con el estado objetivo",
  ...
  "Français": {
    ...
    "app.release_history": "Historique des versions",
    "app.release_history_open": "Ouvrir l’historique des versions",
    "settings.cluster_resolution_select": "Choisir la résolution des clusters",
    "settings.cluster_navigation_session_aria": "Durée de session de navigation des clusters",
    "settings.cluster_navigation_seconds_aria": "Durée de session de navigation des clusters en secondes",
    "settings.cluster_navigation_infinite_aria": "Maintenir la navigation des clusters sans limite",
    "settings.cluster_navigation_to_session": "Passer à la durée de session",
    "settings.cluster_navigation_to_infinite": "Passer au mode illimité",
    "settings.map_startup_select": "Choisir la vue par défaut",
    "map.medallion_move": "Déplacer le médaillon sur la carte",
    "compass.picker_title": "Sélection de la boussole",
    "compass.picker_change": "Changer de boussole",
    ...
    "modules.status.duplicate": "enregistrement en double",
    "modules.deviation.registrations": "Enregistrements",
    "modules.deviation.active_matches": "La version active du module correspond à l’état cible",
    "modules.status.ok": "correct",
  ...
  "Nederlands": {
    ...
    "app.release_history": "Versiegeschiedenis",
    "app.release_history_open": "Versiegeschiedenis openen",
    "settings.cluster_resolution_select": "Clusterresolutie kiezen",
    "settings.cluster_navigation_session_aria": "Sessieduur van clusternavigatie",
    "settings.cluster_navigation_seconds_aria": "Sessieduur van clusternavigatie in seconden",
    "settings.cluster_navigation_infinite_aria": "Clusternavigatie onbeperkt behouden",
    "settings.cluster_navigation_to_session": "Naar sessieduur schakelen",
    "settings.cluster_navigation_to_infinite": "Naar onbeperkt schakelen",
    "settings.map_startup_select": "Standaardweergave kiezen",
    "map.medallion_move": "Medaillon op de kaart verplaatsen",
    "compass.picker_title": "Kompaskeuze",
    "compass.picker_change": "Kompas wisselen",
    ...
    "modules.status.duplicate": "dubbele registratie",
    "modules.deviation.registrations": "Registraties",
    "modules.deviation.active_matches": "De actieve moduleversie komt overeen met de doelstatus",
    "modules.status.ok": "correct",
  ...
  "Polski": {
    ...
    "app.release_history": "Historia wersji",
    "app.release_history_open": "Otwórz historię wersji",
    "settings.cluster_resolution_select": "Wybierz rozdzielczość klastrów",
    "settings.cluster_navigation_session_aria": "Czas sesji nawigacji klastrów",
    "settings.cluster_navigation_seconds_aria": "Czas sesji nawigacji klastrów w sekundach",
    "settings.cluster_navigation_infinite_aria": "Utrzymuj nawigację klastrów bez limitu",
    "settings.cluster_navigation_to_session": "Przełącz na czas sesji",
    "settings.cluster_navigation_to_infinite": "Przełącz na bez limitu",
    "settings.map_startup_select": "Wybierz widok domyślny",
    "map.medallion_move": "Przenieś medalion na mapie",
    "compass.picker_title": "Wybór kompasu",
    "compass.picker_change": "Zmień kompas",
    ...
    "modules.status.duplicate": "zduplikowana rejestracja",
    "modules.deviation.registrations": "Rejestracje",
    "modules.deviation.active_matches": "Aktywna wersja modułu jest zgodna ze stanem docelowym",
  ...
  "Português": {
    ...
    "settings.cluster_navigation_range": "5 - 3600 s",
    "settings.cluster_navigation_infinite": "infinito",
    "app.release_history": "Histórico de versões",
    "app.release_history_open": "Abrir histórico de versões",
    "settings.cluster_resolution_select": "Selecionar resolução de clusters",
    "settings.cluster_navigation_session_aria": "Duração da sessão da navegação de clusters",
    "settings.cluster_navigation_seconds_aria": "Duração da sessão da navegação de clusters em segundos",
    "settings.cluster_navigation_infinite_aria": "Manter a navegação de clusters sem limite",
    "settings.cluster_navigation_to_session": "Mudar para duração da sessão",
    "settings.cluster_navigation_to_infinite": "Mudar para sem limite",
    "settings.map_startup_select": "Selecionar vista predefinida",
    "map.medallion_move": "Mover o medalhão no mapa",
    "compass.picker_title": "Seleção da bússola",
    "compass.picker_change": "Mudar bússola",
    ...
    "modules.status.duplicate": "registo duplicado",
    "modules.deviation.registrations": "Registos",
    "modules.deviation.active_matches": "A versão ativa do módulo corresponde ao estado de destino",
  ...
  "Svenska": {
    ...
    "app.release_history": "Versionshistorik",
    "app.release_history_open": "Öppna versionshistorik",
    "settings.cluster_resolution_select": "Välj klusterupplösning",
    "settings.cluster_navigation_session_aria": "Sessionstid för klusternavigering",
    "settings.cluster_navigation_seconds_aria": "Sessionstid för klusternavigering i sekunder",
    "settings.cluster_navigation_infinite_aria": "Behåll klusternavigering obegränsad",
    "settings.cluster_navigation_to_session": "Växla till sessionstid",
    "settings.cluster_navigation_to_infinite": "Växla till obegränsat",
    "settings.map_startup_select": "Välj standardvy",
    "map.medallion_move": "Flytta medaljongen på kartan",
    "compass.picker_title": "Kompassval",
    "compass.picker_change": "Byt kompass",
    ...
    "modules.status.duplicate": "dubbel registrering",
    "modules.deviation.registrations": "Registreringar",
    "modules.deviation.active_matches": "Den aktiva modulversionen matchar målstatusen",
    "modules.status.ok": "korrekt",
  ...
  "Italiano": {
    ...
    "settings.cluster_navigation_range": "5 - 3600 s",
    "settings.cluster_navigation_infinite": "infinito",
    "app.release_history": "Cronologia versioni",
    "app.release_history_open": "Apri cronologia versioni",
    "settings.cluster_resolution_select": "Seleziona risoluzione cluster",
    "settings.cluster_navigation_session_aria": "Durata sessione navigazione cluster",
    "settings.cluster_navigation_seconds_aria": "Durata sessione navigazione cluster in secondi",
    "settings.cluster_navigation_infinite_aria": "Mantieni illimitata la navigazione cluster",
    "settings.cluster_navigation_to_session": "Passa alla durata della sessione",
    "settings.cluster_navigation_to_infinite": "Passa a illimitato",
    "settings.map_startup_select": "Seleziona vista predefinita",
    "map.medallion_move": "Sposta il medaglione sulla mappa",
    "compass.picker_title": "Selezione bussola",
    "compass.picker_change": "Cambia bussola",
    ...
    "modules.status.duplicate": "registrazione duplicata",
    "modules.deviation.registrations": "Registrazioni",
    "modules.deviation.active_matches": "La versione attiva del modulo corrisponde allo stato previsto",
  ...
  "Norsk bokmål": {
    ...
    "settings.cluster_navigation_range": "5 - 3600 sek.",
    "settings.cluster_navigation_infinite": "uendelig",
    "app.release_history": "Versjonshistorikk",
    "app.release_history_open": "Åpne versjonshistorikk",
    "settings.cluster_resolution_select": "Velg klyngeoppløsning",
    "settings.cluster_navigation_session_aria": "Økttid for klyngenavigasjon",
    "settings.cluster_navigation_seconds_aria": "Økttid for klyngenavigasjon i sekunder",
    "settings.cluster_navigation_infinite_aria": "Behold klyngenavigasjon ubegrenset",
    "settings.cluster_navigation_to_session": "Bytt til økttid",
    "settings.cluster_navigation_to_infinite": "Bytt til ubegrenset",
    "settings.map_startup_select": "Velg standardvisning",
    "map.medallion_move": "Flytt medaljongen på kartet",
    "compass.picker_title": "Kompassvalg",
    "compass.picker_change": "Bytt kompass",
    "settings.map_display": "Kartvisning",
    "settings.map_startup": "Standardvisning",
    ...
    "modules.status.duplicate": "duplikatregistrering",
    "modules.deviation.registrations": "Registreringer",
    "modules.deviation.active_matches": "Den aktive modulversjonen samsvarer med målstatusen",
    "modules.status.ok": "korrekt",
    "modules.status.missing": "mangler",
  ...
  "Suomi": {
    ...
    "app.release_history": "Versiohistoria",
    "app.release_history_open": "Avaa versiohistoria",
    "settings.cluster_resolution_select": "Valitse klusterin erottelutaso",
    "settings.cluster_navigation_session_aria": "Klusterinavigoinnin istuntoaika",
    "settings.cluster_navigation_seconds_aria": "Klusterinavigoinnin istuntoaika sekunteina",
    "settings.cluster_navigation_infinite_aria": "Pidä klusterinavigointi rajoittamattomana",
    "settings.cluster_navigation_to_session": "Vaihda istuntoaikaan",
    "settings.cluster_navigation_to_infinite": "Vaihda rajoittamattomaan",
    "settings.map_startup_select": "Valitse oletusnäkymä",
    "map.medallion_move": "Siirrä medaljonkia kartalla",
    "compass.picker_title": "Kompassin valinta",
    "compass.picker_change": "Vaihda kompassia",
    ...
    "modules.status.duplicate": "päällekkäinen rekisteröinti",
    "modules.deviation.registrations": "Rekisteröinnit",
    "modules.deviation.active_matches": "Aktiivinen moduuliversio vastaa tavoitetilaa",
  ...
  "Čeština": {
    ...
    "app.release_history": "Historie verzí",
    "app.release_history_open": "Otevřít historii verzí",
    "settings.cluster_resolution_select": "Vybrat rozlišení shluků",
    "settings.cluster_navigation_session_aria": "Doba relace navigace shluků",
    "settings.cluster_navigation_seconds_aria": "Doba relace navigace shluků v sekundách",
    "settings.cluster_navigation_infinite_aria": "Ponechat navigaci shluků bez omezení",
    "settings.cluster_navigation_to_session": "Přepnout na dobu relace",
    "settings.cluster_navigation_to_infinite": "Přepnout na bez omezení",
    "settings.map_startup_select": "Vybrat výchozí zobrazení",
    "map.medallion_move": "Přesunout medailon na mapě",
    "compass.picker_title": "Výběr kompasu",
    "compass.picker_change": "Změnit kompas",
    ...
    "modules.status.duplicate": "duplicitní registrace",
    "modules.deviation.registrations": "Registrace",
    "modules.deviation.active_matches": "Aktivní verze modulu odpovídá cílovému stavu",
  ...
  "Ελληνικά": {
    ...
    "app.release_history": "Ιστορικό εκδόσεων",
    "app.release_history_open": "Άνοιγμα ιστορικού εκδόσεων",
    "settings.cluster_resolution_select": "Επιλογή ανάλυσης συστάδων",
    "settings.cluster_navigation_session_aria": "Διάρκεια συνεδρίας πλοήγησης συστάδων",
    "settings.cluster_navigation_seconds_aria": "Διάρκεια συνεδρίας πλοήγησης συστάδων σε δευτερόλεπτα",
    "settings.cluster_navigation_infinite_aria": "Διατήρηση της πλοήγησης συστάδων χωρίς όριο",
    "settings.cluster_navigation_to_session": "Μετάβαση στη διάρκεια συνεδρίας",
    "settings.cluster_navigation_to_infinite": "Μετάβαση σε χωρίς όριο",
    "settings.map_startup_select": "Επιλογή προεπιλεγμένης προβολής",
    "map.medallion_move": "Μετακίνηση του μεταλλίου στον χάρτη",
    "compass.picker_title": "Επιλογή πυξίδας",
    "compass.picker_change": "Αλλαγή πυξίδας",
    ...
    "modules.status.duplicate": "διπλή καταχώριση",
    "modules.deviation.registrations": "Καταχωρίσεις",
    "modules.deviation.active_matches": "Η ενεργή έκδοση μονάδας αντιστοιχεί στην αναμενόμενη κατάσταση",
  ...
  "Magyar": {
    ...
    "app.release_history": "Verzióelőzmények",
    "app.release_history_open": "Verzióelőzmények megnyitása",
    "settings.cluster_resolution_select": "Klaszterfelbontás kiválasztása",
    "settings.cluster_navigation_session_aria": "Klaszternavigáció munkamenet-ideje",
    "settings.cluster_navigation_seconds_aria": "Klaszternavigáció munkamenet-ideje másodpercben",
    "settings.cluster_navigation_infinite_aria": "Klaszternavigáció korlátlan fenntartása",
    "settings.cluster_navigation_to_session": "Váltás munkamenet-időre",
    "settings.cluster_navigation_to_infinite": "Váltás korlátlanra",
    "settings.map_startup_select": "Alapértelmezett nézet kiválasztása",
    "map.medallion_move": "Medál mozgatása a térképen",
    "compass.picker_title": "Iránytű kiválasztása",
    "compass.picker_change": "Iránytű váltása",
    ...
    "modules.status.duplicate": "duplikált regisztráció",
    "modules.deviation.registrations": "Regisztrációk",
    "modules.deviation.active_matches": "Az aktív modulverzió megfelel a célállapotnak",
  ...
  "Boarisch": {
    ...
    "settings.cluster_navigation_infinite": "unendlich",
    "app.release_history": "Versionsverlauf",
    "app.release_history_open": "Versionsverlauf aufmochn",
    "settings.cluster_resolution_select": "Cluster-Auflösung aussuacha",
    "settings.cluster_navigation_session_aria": "Sitzungszeit vo da Cluster-Navigation",
    "settings.cluster_navigation_seconds_aria": "Sitzungszeit vo da Cluster-Navigation in Sekundn",
    "settings.cluster_navigation_infinite_aria": "Cluster-Navigation unbegrenzt lossn",
    "settings.cluster_navigation_to_session": "Zur Sitzungszeit umschaltn",
    "settings.cluster_navigation_to_infinite": "Auf unbegrenzt umschaltn",
    "settings.map_startup_select": "Standardansicht aussuacha",
    "map.medallion_move": "Medaillon auf da Kartn verschiabn",
    "compass.picker_title": "Kompassauswahl",
    "compass.picker_change": "Kompass wechseln",
    ...
    "modules.status.duplicate": "doppelte Registrierung",
    "modules.deviation.registrations": "Registrierungen",
    "modules.deviation.active_matches": "Aktive Modulversion passt zum Sollstand",
  ...
  "Plattdüütsch": {
    ...
    "app.release_history": "Verschoonshistorie",
    "app.release_history_open": "Verschoonshistorie opmaken",
    "settings.cluster_resolution_select": "Cluster-Oplösen utsöken",
    "settings.cluster_navigation_session_aria": "Sittungstiet vun de Cluster-Navigation",
    "settings.cluster_navigation_seconds_aria": "Sittungstiet vun de Cluster-Navigation in Sekunnen",
    "settings.cluster_navigation_infinite_aria": "Cluster-Navigation ahn Enn behollen",
    "settings.cluster_navigation_to_session": "Na de Sittungstiet wesseln",
    "settings.cluster_navigation_to_infinite": "Na ahn Enn wesseln",
    "settings.map_startup_select": "Standardansicht utsöken",
    "map.medallion_move": "Medaillon op de Koort verschuven",
    "compass.picker_title": "Kompassutwahl",
    "compass.picker_change": "Kompass wesseln",
    ...
    "modules.status.duplicate": "duppelte Registreren",
    "modules.deviation.registrations": "Registreren",
    "modules.deviation.active_matches": "Aktive Modulverschoon passt to’n Sollstand",
  ...
  "Sächs’sch": {
    ...
    "app.release_history": "Versionsverlauf",
    "app.release_history_open": "Versionsverlauf öffn",
    "settings.cluster_resolution_select": "Cluster-Auflösung auswählen",
    "settings.cluster_navigation_session_aria": "Sitzungszeit von dr Cluster-Navigation",
    "settings.cluster_navigation_seconds_aria": "Sitzungszeit von dr Cluster-Navigation in Sekunden",
    "settings.cluster_navigation_infinite_aria": "Cluster-Navigation unbegrenzt lassn",
    "settings.cluster_navigation_to_session": "Zur Sitzungszeit wechsel",
    "settings.cluster_navigation_to_infinite": "Auf unbegrenzt wechsel",
    "settings.map_startup_select": "Standardansicht auswählen",
    "map.medallion_move": "Medaillon uff dr Karte verschiebn",
    "compass.picker_title": "Kompassauswahl",
    "compass.picker_change": "Kompass wechsel",
    "settings.map_display": "Kartendarstellung",
    "settings.map_startup": "Standardansicht",
  ...
  "Schwäbisch": {
    ...
    "app.release_history": "Versionsverlauf",
    "app.release_history_open": "Versionsverlauf aufmacha",
    "settings.cluster_resolution_select": "Cluster-Auflösung auswähla",
    "settings.cluster_navigation_session_aria": "Sitzungszeit von dr Cluster-Navigation",
    "settings.cluster_navigation_seconds_aria": "Sitzungszeit von dr Cluster-Navigation in Sekonda",
    "settings.cluster_navigation_infinite_aria": "Cluster-Navigation unbegrenzt lau lass",
    "settings.cluster_navigation_to_session": "Zur Sitzungszeit wechsla",
    "settings.cluster_navigation_to_infinite": "Auf unbegrenzt wechsla",
    "settings.map_startup_select": "Standardansicht auswähla",
    "map.medallion_move": "Medaillon auf dr Karta verschieba",
    "compass.picker_title": "Kompassauswahl",
    "compass.picker_change": "Kompass wechsla",
