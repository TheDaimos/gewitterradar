...
- [x] Vollständige 19-Sprachen-Matrix nach der TEST9-Stabilisierung kontrolliert **erst nach** der byte-identischen, real akzeptierten TEST9R2-Basis wieder in den Laufzeitkandidaten eingesetzt. TEST10 prüft die 19 Suchoberflächen-Sprachen und die 17 zusätzlich gepatchten Hilfe-Sprachen automatisiert; die CI ist erfolgreich.
- [ ] TEST10-Sprachmatrix auf realen Geräten stichprobenartig abnehmen, insbesondere lange Beschriftungen, Sonderzeichen, Dialekte und die neuen Hilfe-/Netzwerktexte.
...
- [x] Shield-Serie **Variante 2** technisch in TEST10 übernommen: vereinfachtes Schutzschild mit klarer RJ45-/Netzwerkbuchsen-Symbolik für die kleine Darstellung unter **Externe Dienste & Netzwerkfreigaben**; eingebettetes `currentColor`-SVG ohne zusätzliche Datei oder externe Laufzeitabhängigkeit.
- [ ] Shield-Variante 2 in der realen kleinen Hilfe-Darstellung visuell abnehmen.
